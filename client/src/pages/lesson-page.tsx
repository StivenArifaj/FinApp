...
export default function LessonPage() {
  ...
  // Make sure questions array exists and has at least one item
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="bg-white p-4 shadow-sm">
        ...
        <Progress value={lessonData?.progress || 0} className="w-full h-2" />
        <div className="flex justify-between text-xs mt-1 text-dark/60">
          <span>Question {lessonData?.currentQuestion || 0}/{lessonData?.totalQuestions || 0}</span>
